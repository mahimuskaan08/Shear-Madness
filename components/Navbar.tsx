...
export default function Navbar() {
  ...
  return (
    <>
      ...
      >
        <div className="w-full px-6 xl:px-10 flex items-center h-[66px] xl:h-[72px] relative">

          {/* ── LOGO — absolute left edge ─────────────────────────────── */}
          <motion.a
            href="/"
            className="absolute left-6 xl:left-10 z-10 flex items-center gap-3"
          ...
          <nav
            className="hidden xl:flex items-center gap-4 2xl:gap-6 absolute -translate-x-1/2"
            style={{
              left: "50%",
            ...
            {navLinks.map((link) =>
              link.dropdown ? (
                ...
                >
                  <a
                    href={link.href}
                    className="relative text-[#2C2A25] text-[10px] 2xl:text-[11.5px] tracking-[0.12em] 2xl:tracking-[0.14em] uppercase font-black transition-colors duration-300 hover:text-[#C4A96A] flex items-center gap-1 whitespace-nowrap"
                ...
                <a
                  key={link.label}
                  href={link.href}
                  className="relative text-[#2C2A25] text-[10px] 2xl:text-[11.5px] tracking-[0.12em] 2xl:tracking-[0.14em] uppercase font-black transition-colors duration-300 hover:text-[#C4A96A] group whitespace-nowrap"
                  style={{ fontFamily: "'Neue World', Georgia, serif", fontWeight: 900 }}
                >
                  {link.label}
